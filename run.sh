...
git clone --depth=1 https://github.com/morezig/odoo-18-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: passr0rd123 | Live chat port: $CHAT"